...
- **Concepts** — Core ideas: agentic workflows, skill design, prompting, MCP, self-annealing systems
...
├── raw/              # Source materials (articles, notes, exports)
├── meta/             # Patterns detected, open questions, health checks
└── log.md            # Activity log of all operations
```
...
Every claim in an entity or concept page traces to a source page. Contradictions get flagged with a `## Conflicts` section rather than silently overwritten.
